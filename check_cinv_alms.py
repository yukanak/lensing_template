...
elm = hp.read_alm(f'/oak/stanford/orgs/kipac/users/yukanaka/lensing_template/cinv_lowellmap_19-20/v3mocks_musebeamv41_uncorr/cinv_output_test_uncorr/sim_0001_elm.fits')
blm = hp.read_alm(f'/oak/stanford/orgs/kipac/users/yukanaka/lensing_template/cinv_lowellmap_19-20/v3mocks_musebeamv41_uncorr/cinv_output_test_uncorr/sim_0001_blm.fits')
...
#plt.plot(ell, clee, color='lightgreen', linestyle='-', label='spec of (cinv elm * clee) / fsky, new pipeline')
#plt.plot(ell, clbb, color='powderblue', linestyle='-', label='spec of (cinv blm * clbb) / fsky, new pipeline')
plt.plot(ell, clee_avg, color='forestgreen', linestyle='-', label='spec of (cinv elm * clee) / fsky, sims')
#plt.plot(ell, clbb_avg, color='darkblue', linestyle='-', label='spec of (cinv blm * clbb) / fsky, sims')
plt.plot(ell, clee_data, color='lightgreen', linestyle='-', label='spec of (cinv elm * clee) / fsky, data')
...
plt.plot(ell, moving_average(clee_avg/clee_data, window_size=40), color='forestgreen', linestyle='-', alpha=0.8, label='input cinv clee ratio, sims / data')
