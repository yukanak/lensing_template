...
#lmax = btmp.lmax_b
#idxs = np.arange(10)+1
#weights1_L = np.load('/oak/stanford/orgs/kipac/users/yukanaka/lensing_template/combined_tracer_weights/gnilc_pr3_cib_pr4_kappa_standard/klm1_weight_tuned_sims1to10_seed1.npy')
#weights2_L = np.load('/oak/stanford/orgs/kipac/users/yukanaka/lensing_template/combined_tracer_weights/gnilc_pr3_cib_pr4_kappa_standard/klm2_weight_tuned_sims1to10_seed1.npy')
...
#    k1 = klm1[i-idxs[0],:]                                                  
#    k2 = klm2[i-idxs[0],:]                                                  
#    klm_combined = hp.almxfl(k1,weights1_L) + hp.almxfl(k2,weights2_L)
...
cross /= 10
auto_in /= 10
#fname = '/oak/stanford/orgs/kipac/users/yukanaka/lensing_template/btemplates/combined_gnilc_pr3_cib_pr4_kappa_standard/btmpl_specs_0000.npz'
fname = '/oak/stanford/orgs/kipac/users/yukanaka/lensing_template/btemplates/combined_agora545_cib_agora_kappa_standard/btmpl_specs_5001.npz'
tmp   = np.load(fname)
auto_data  = tmp['auto']
...
auto_in1 = 0
for i in np.arange(10)+1:
    fname = f'/oak/stanford/orgs/kipac/users/yukanaka/lensing_template/btemplates/combined_gnilc_pr3_cib_pr4_kappa_standard/tuned/btmpl_specs_{i:04d}.npz'
    tmp = np.load(fname)
    auto1 += tmp['auto']
    cross1 += tmp['cross']
...
#weightsdir = btmp_agora.combined_tracer_weights_dir
weights1 = np.load(weightsdir+'/klm1_weight_rhos.npy')
weights2 = np.load(weightsdir+'/klm2_weight_rhos.npy')
A1_bins = np.load(weightsdir+'/A1_bins_klm1_weight_tuned_sim0_seed1.npy')
A2_bins = np.load(weightsdir+'/A2_bins_klm2_weight_tuned_sim0_seed1.npy')
#A1_bins = np.load(weightsdir+'/A1_bins_klm1_weight_tuned_sims1to10_seed1.npy')
#A2_bins = np.load(weightsdir+'/A2_bins_klm2_weight_tuned_sims1to10_seed1.npy')
#A1_bins = np.load(weightsdir+'/A1_bins_klm1_weight_tuned_sim5001_seed1.npy')
#A2_bins = np.load(weightsdir+'/A2_bins_klm2_weight_tuned_sim5001_seed1.npy')
